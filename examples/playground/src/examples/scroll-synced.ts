...
export const scrollSynced: Example = {
  ...
  title: "Scroll-synced",
  description:
    "Scroll the page. This bar's width tracks this card's position through the viewport.",
  mount(stage) {
    ...
    bar.style.background =
      "linear-gradient(90deg, #7c9cff 0%, #7c9cff var(--p, 0%), #141821 var(--p, 0%))"
    ...
    const handle = scroll(tween({ opacity: [0, 1] }, { duration: 1 }), stage, {
      sync: true,
