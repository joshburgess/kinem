...
### interface `CombinedMotionValueStore`
...
```ts
export declare function combine<S extends readonly MotionValue<unknown>[], T>(sources: S, fn: (...values: SourceValues<S>) => T): CombinedMotionValueStore<T>;
```
