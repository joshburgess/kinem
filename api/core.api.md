...
```ts
export declare function bezierPath(points: readonly Point2[], opts?: BezierPathOpts): AnimationDef<BezierPathValue>;
```

### function `bezierPathLength`

```ts
export declare function bezierPathLength(points: readonly Point2[], samplesPerSegment?: number): number;
```
...
```ts
export declare function catmullRom(waypoints: readonly Point2[], opts?: CatmullRomOpts): AnimationDef<BezierPathValue>;
```

### function `catmullRomToCubicPoints`

```ts
export declare function catmullRomToCubicPoints(waypoints: readonly Point2[], tension: number, closed: boolean): Point2[];
```
...
```ts
export declare function deCasteljau(points: readonly Point2[], t: number): Point2;
```
...
```ts
export declare function sampleBezierPath(points: readonly Point2[], samples: number, samplesPerSegment?: number): Point2[];
```
...
```ts
export declare function svgPathToCubicPoints(d: string): readonly Point2[];
```
